...
equation
  connect(resistor1.p, trapezoidVoltage1.n) annotation(
    Line(points = {{-50, 116}, {-50, 116}, {-50, 140}, {-50, 140}}, color = {0, 0, 255}));
  connect(trapezoidVoltage1.p, resistor1.n) annotation(
    Line(points = {{-30, 140}, {-30, 140}, {-30, 116}, {-30, 116}}, color = {0, 0, 255}));
  connect(trapezoidVoltage1.p, idealCommutingSwitch1.n2) annotation(
    Line(points = {{-30, 140}, {-2, 140}, {-2, 140}, {-2, 140}}, color = {0, 0, 255}));
  connect(trapezoidVoltage1.n, idealCommutingSwitch2.n2) annotation(
    Line(points = {{-50, 140}, {-88, 140}, {-88, 140}, {-88, 140}}, color = {0, 0, 255}));
  ...
  connect(Cap_C.n, idealCommutingSwitch2.p) annotation(
    Line(points = {{-172, 22}, {-172, 22}, {-172, 140}, {-108, 140}, {-108, 140}}, color = {0, 0, 255}));
