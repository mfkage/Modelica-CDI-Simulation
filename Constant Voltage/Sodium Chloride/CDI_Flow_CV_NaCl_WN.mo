model CDI_Flow_CV_NaCl_WN
  ...
  Modelica.Electrical.Analog.Sources.StepVoltage stepVoltage1(V = 0.1, offset = 0, startTime = 3600) annotation(
    Placement(visible = true, transformation(origin = {-40, 140}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
equation
  connect(Cap_A.p, stepVoltage1.p) annotation(
    Line(points = {{142, 36}, {142, 36}, {142, 140}, {-30, 140}, {-30, 140}}, color = {0, 0, 255}));
  connect(Cap_C.n, stepVoltage1.n) annotation(
    Line(points = {{-172, 22}, {-174, 22}, {-174, 140}, {-50, 140}, {-50, 140}}, color = {0, 0, 255}));
  connect(stepVoltage1.n, resistor1.p) annotation(
    Line(points = {{-50, 140}, {-50, 140}, {-50, 116}, {-50, 116}}, color = {0, 0, 255}));
  connect(stepVoltage1.p, resistor1.n) annotation(
    Line(points = {{-30, 140}, {-30, 140}, {-30, 116}, {-30, 116}}, color = {0, 0, 255}));
...
//n_diff_Cl = (CA_Cl.amountOfSubstance - n0_CA_Cl + CC_Cl.amountOfSubstance - n0_CC_Cl) * Cal_factor; //[mmol]
  ...
  Adsorptionszeit = time - stepVoltage1.startTime + 0.0000001; //[s] +0.0000001 weil sonst bei time = 3000 s die Adsorptionszeit 0 beträgt
