model CDI_Flow_CV_MaleicAcid_WN
  extends Chemical;
  ...
  Modelica.Blocks.Sources.Constant const(k = 6.6666667e-8) annotation(
    Placement(visible = true, transformation(origin = {-23, -220}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant const1(k = 6.6666667e-8) annotation(
  ...
  Modelica.Blocks.Sources.Constant RC(k = 1) annotation(
  ...
  Modelica.Electrical.Analog.Basic.Resistor resistor1(R = 25) annotation(
  ...
  Modelica.Electrical.Analog.Sources.StepVoltage stepVoltage1(V = 0.2, startTime = 3600)  annotation(
    Placement(visible = true, transformation(origin = {-12, 158}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(Cap_C.n, stepVoltage1.p) annotation(
    Line(points = {{-156, 34}, {-156, 34}, {-156, 158}, {-22, 158}, {-22, 158}}, color = {0, 0, 255}));
  connect(stepVoltage1.n, Cap_A.p) annotation(
    Line(points = {{-2, 158}, {162, 158}, {162, 36}, {162, 36}}, color = {0, 0, 255}));
  connect(stepVoltage1.p, resistor1.p) annotation(
    Line(points = {{-22, 158}, {-24, 158}, {-24, 130}, {-22, 130}}, color = {0, 0, 255}));
  connect(stepVoltage1.n, resistor1.n) annotation(
    Line(points = {{-2, 158}, {-2, 158}, {-2, 130}, {-2, 130}}, color = {0, 0, 255}));
...
//Adsorbierte Stoffmenge ohne angelegte Spannung. Intervall muss länger sein als die Adsorptionszeit
  ...
  n_diff_Ma1 = (CA_Ma1.amountOfSubstance - n0_CA_Ma1 + CC_Ma1.amountOfSubstance - n0_CC_Ma1) * Cal_factor;
//[mmol]
  n_diff_Ma2 = (CA_Ma2.amountOfSubstance - n0_CA_Ma2 + CC_Ma2.amountOfSubstance - n0_CC_Ma2) * Cal_factor;
//[mmol]
  n_diff_Ma = (CA_Ma.amountOfSubstance - n0_CA_Ma + CC_Ma.amountOfSubstance - n0_CC_Ma) * Cal_factor;
//[mmol]
  pH = -log10(H.a);
  SAC = (n_diff_Ma1 + n_diff_Ma2 + n_diff_Ma) / m_AK;
//[mmol/g]
  Adsorptionszeit = time - stepVoltage1.startTime + 0.0000001;
//[s] +0.0000001 weil sonst bei time = 3000 s die Adsorptionszeit 0 beträgt
  ASAR = SAC / Adsorptionszeit;
//[mmol/(g*s)]
