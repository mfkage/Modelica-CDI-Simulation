model CDI_Flow_CV_MaleicAcid
  ...
  Modelica.Electrical.Analog.Sources.TrapezoidVoltage trapezoidVoltage1(V = 0.1, falling = 1, nperiod = 1, period = 3600, rising = 1, startTime = 3600, width = 3598)  annotation(
    Placement(visible = true, transformation(origin = {-14, 152}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(trapezoidVoltage1.p, idealCommutingSwitch2.n2) annotation(
    Line(points = {{-24, 152}, {-64, 152}, {-64, 152}, {-64, 152}}, color = {0, 0, 255}));
  connect(trapezoidVoltage1.n, idealCommutingSwitch1.n2) annotation(
    Line(points = {{-4, 152}, {22, 152}, {22, 152}, {22, 152}}, color = {0, 0, 255}));
  connect(resistor1.p, trapezoidVoltage1.p) annotation(
    Line(points = {{-22, 130}, {-24, 130}, {-24, 152}, {-24, 152}}, color = {0, 0, 255}));
  connect(trapezoidVoltage1.n, resistor1.n) annotation(
    Line(points = {{-4, 152}, {-4, 152}, {-4, 130}, {-2, 130}}, color = {0, 0, 255}));
...
//[mmol/g]
  Adsorptionszeit = time - trapezoidVoltage1.startTime + 0.0000001;
