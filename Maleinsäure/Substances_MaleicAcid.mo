package Substances_MaleicAcid "Definitions of substances"
  ...
  MolarWeight = 0.018015, z = 0, DfG_25degC_1bar = 0, Cp = 20.8, gamma = 55.345);
  ...
  MolarWeight = 0.018015, z = 0, DfG_25degC_1bar = -632200, Cp = 20.8, gamma = 55.345);
  ...
  MolarWeight = 0.018015, z = 0, DfG_25degC_1bar = -621355, Cp = 20.8, gamma = 55.345); //-589355
  ...
  MolarWeight = 0.018015, z = 0, DfG_25degC_1bar = -584255, Cp = 20.8, gamma = 55.345);
  ...
  MolarWeight = 0.018015, z = 0, DfG_25degC_1bar = -261870, Cp = 20.8, gamma = 55.345);
