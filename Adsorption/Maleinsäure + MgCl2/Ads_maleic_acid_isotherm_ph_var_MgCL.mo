model Ads_maleic_acid_isotherm_ph_var_MgCL
  ...
  Chemical.Components.Substance MaleicAcid(amountOfSubstance_start = 0.01, substanceData = Substances_190425_Ad.MaleicAcid) annotation(
  ...
  Chemical.Components.Substance OH(substanceData = Substances_190425_Ad.Hydroxide_aqueous) annotation(
  ...
  Chemical.Components.Substance C_NaCarb(amountOfSubstance_start = 0.0035, substanceData = Substances_190425_Ad.NaCarboxy_solid) annotation(
  ...
  Chemical.Components.Substance Na(substanceData = Substances_190425_Ad.Sodium_aqueous) annotation(
  ...
  Chemical.Components.Reaction reaction7(KC = 0.0001, nP = 1, nS = 3, s = {1, 1, 2}, useKineticsInput = true) annotation(
    Placement(visible = true, transformation(origin = {-20, -18}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  ...
  Chemical.Components.Substance C_Base(amountOfSubstance_start = 0.0035) annotation(
...
equation
  connect(substanceInflow2.port_b, Na.port_a) annotation(
    Line(points = {{108, -18}, {32, -18}, {32, -56}, {32, -56}}, color = {158, 66, 200}));
  connect(Mg2.solution, solution2.solution) annotation(
    Line(points = {{8, -28}, {11.5, -28}, {11.5, -66}, {65, -66}}, color = {127, 127, 0}));
  connect(Mg2.port_a, reaction7.substrates[1]) annotation(
    Line(points = {{24, -18}, {-10, -18}}, color = {158, 66, 200}));
  connect(CL.port_a, reaction7.substrates[2]) annotation(
    Line(points = {{-72, 28}, {-10, 28}, {-10, -18}}, color = {158, 66, 200}));
  connect(electronTransfer1.port_a, reaction7.substrates[3]) annotation(
    Line(points = {{-128, -16}, {-68, -16}, {-68, -18}, {-10, -18}}, color = {158, 66, 200}));
  connect(RC_ads.y, reaction7.kineticsCoefficientInput) annotation(
    Line(points = {{-13, 166}, {-13, 90}, {-14, 90}, {-14, -14}}, color = {0, 0, 127}));
  connect(reaction7.products[1], C_Mg.port_a) annotation(
    Line(points = {{-30, -18}, {-44, -18}}, color = {158, 66, 200}, thickness = 0.5));
  connect(CL.port_a, reaction4.substrates[2]) annotation(
    Line(points = {{-72, 28}, {-8, 28}, {-8, -46}}, color = {158, 66, 200}));
  connect(Cl.port_a, reaction4.substrates[1]) annotation(
    Line(points = {{64, -50}, {27, -50}, {27, -46}, {-8, -46}}, color = {158, 66, 200}));
  connect(reaction4.products[1], C_Cl.port_a) annotation(
    Line(points = {{-28, -46}, {-58, -46}}, color = {158, 66, 200}, thickness = 0.5));
  connect(reaction4.products[2], electronTransfer1.port_a) annotation(
    Line(points = {{-28, -46}, {-74, -46}, {-74, -16}, {-128, -16}}, color = {158, 66, 200}, thickness = 0.5));
  connect(RC_ads.y, reaction4.kineticsCoefficientInput) annotation(
    Line(points = {{-13, 166}, {-12, 166}, {-12, -42}}, color = {0, 0, 127}));
  connect(CL.port_a, reaction6.substrates[2]) annotation(
    Line(points = {{-72, 28}, {-4, 28}, {-4, -60}}, color = {158, 66, 200}));
  connect(reaction6.products[1], C_Na.port_a) annotation(
    Line(points = {{-24, -60}, {-57, -60}, {-57, -58}, {-90, -58}}, color = {158, 66, 200}, thickness = 0.5));
  connect(electronTransfer1.port_a, reaction6.substrates[3]) annotation(
    Line(points = {{-128, -16}, {-128, -59}, {-4, -59}, {-4, -60}}, color = {158, 66, 200}));
  connect(RC_ads.y, reaction6.kineticsCoefficientInput) annotation(
    Line(points = {{-13, 166}, {-13, 61}, {-8, 61}, {-8, -56}}, color = {0, 0, 127}));
  connect(Na.port_a, reaction6.substrates[1]) annotation(
    Line(points = {{32, -56}, {17, -56}, {17, -60}, {-4, -60}}, color = {158, 66, 200}));
  connect(MaleicAcid.port_a, reaction2.substrates[1]) annotation(
    Line(points = {{24, 14}, {24, 18}, {28, 18}, {28, -8}}, color = {158, 66, 200}));
  connect(MaleicAcid.solution, solution2.solution) annotation(
  ...
  connect(Na.solution, solution2.solution) annotation(
    Line(points = {{16, -66}, {65, -66}}, color = {127, 127, 0}));
  connect(RC_flow.y, substanceInflow1.substanceFlow) annotation(
    Line(points = {{139, 56}, {108, 56}}, color = {0, 0, 127}));
  connect(substanceInflow1.port_b, OH.port_a) annotation(
    Line(points = {{102, 52}, {82, 52}, {82, 62}, {56, 62}}, color = {158, 66, 200}));
