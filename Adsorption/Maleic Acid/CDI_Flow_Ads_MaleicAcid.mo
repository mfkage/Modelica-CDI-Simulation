...
equation
  ...
  pH = -log10(H.a);
  SAC = (CA_Ma1.amountOfSubstance + CC_Ma1.amountOfSubstance + CA_Ma2.amountOfSubstance + CC_Ma2.amountOfSubstance + CA_Ma.amountOfSubstance + CC_Ma.amountOfSubstance) / m_AK;//[mmol/g]
