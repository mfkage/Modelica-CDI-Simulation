model CDI_Flow_ADS_NaCl_test2
  ...
  Modelica.Electrical.Analog.Basic.Ground ground1 annotation(
    Placement(visible = true, transformation(origin = {-196, -66}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
  Modelica.Electrical.Analog.Basic.Ground ground2 annotation(
    Placement(visible = true, transformation(origin = {168, -72}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
equation
  connect(variableResistor1.p, ground1.p) annotation(
    Line(points = {{-170, -52}, {-198, -52}, {-198, -54}, {-196, -54}}, color = {0, 0, 255}));
  connect(variableResistor2.n, ground2.p) annotation(
    Line(points = {{132, -58}, {168, -58}, {168, -60}, {168, -60}}, color = {0, 0, 255}));
